...
//
#ifndef YTIGameCardRenderer_h
#define YTIGameCardRenderer_h
@import Foundation;
...
@interface YTIGameCardRenderer : GPBMessage <YTVideoCardModel>
...
@property (retain, nonatomic) YTIRenderer *game;
