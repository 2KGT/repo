...
@class NSMutableData, NSObject, NSOutputStream;

@interface GPBCodedOutputStream : NSObject {
    /* instance variables */
    struct GPBOutputBufferState { char *bytes; unsigned long long size; unsigned long long position; unsigned long long bytesFlushed; NSOutputStream *output; } state_;
