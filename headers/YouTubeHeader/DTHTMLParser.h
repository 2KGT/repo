...
//
#ifndef DTHTMLParser_h
#define DTHTMLParser_h
@import Foundation;

#include "DTHTMLParserDelegate-Protocol.h"

@class NSData, NSError, NSMutableString, NSObject, NSString;
...
- (void)_accumulateCharacters:(const char *)characters length:(int)length;
- (_Bool)parse;
- (void)abortParsing;
- (id)delegate;
