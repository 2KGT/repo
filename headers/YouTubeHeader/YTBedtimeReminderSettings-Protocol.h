...
//
#ifndef YTBedtimeReminderSettings_Protocol_h
#define YTBedtimeReminderSettings_Protocol_h
@import Foundation;

#include "NSObject-Protocol.h"

@protocol YTBedtimeReminderSettings <NSObject>
...
#endif /* YTBedtimeReminderSettings_Protocol_h */
