...
//
#ifndef YTIGridPromotedVideoRenderer_h
#define YTIGridPromotedVideoRenderer_h
@import Foundation;
...
@interface YTIGridPromotedVideoRenderer : GPBMessage <YTGridVideoViewModel>
...
@property (retain, nonatomic) YTIGridPromotedVideoCTASupportedRenderers *ctaRenderer;
...
#endif /* YTIGridPromotedVideoRenderer_h */
