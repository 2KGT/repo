...
//
#ifndef LNSLOGFrameProcessorLogData_h
#define LNSLOGFrameProcessorLogData_h
@import Foundation;
...
@interface LNSLOGFrameProcessorLogData : GPBMessage
...
#endif /* LNSLOGFrameProcessorLogData_h */
