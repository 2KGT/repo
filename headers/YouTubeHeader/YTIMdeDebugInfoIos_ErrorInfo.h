...
//
#ifndef YTIMdeDebugInfoIos_ErrorInfo_h
#define YTIMdeDebugInfoIos_ErrorInfo_h
@import Foundation;

#include "GPBMessage.h"

@interface YTIMdeDebugInfoIos_ErrorInfo : GPBMessage
...
#endif /* YTIMdeDebugInfoIos_ErrorInfo_h */
