...
//
#ifndef YTFullWidthSlider_h
#define YTFullWidthSlider_h
@import Foundation;

@class UISlider;

@interface YTFullWidthSlider : UISlider

@property (nonatomic) int yt_sliderStyle;
