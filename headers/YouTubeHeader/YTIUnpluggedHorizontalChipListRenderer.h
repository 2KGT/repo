...
//
#ifndef YTIUnpluggedHorizontalChipListRenderer_h
#define YTIUnpluggedHorizontalChipListRenderer_h
@import Foundation;
...
@property (nonatomic) _Bool hideDefaultChip;
@property (nonatomic) _Bool hasHideDefaultChip;
...
#endif /* YTIUnpluggedHorizontalChipListRenderer_h */
