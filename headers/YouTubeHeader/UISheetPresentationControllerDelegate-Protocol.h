...
//
#ifndef UISheetPresentationControllerDelegate_Protocol_h
#define UISheetPresentationControllerDelegate_Protocol_h
@import Foundation;
...
#endif /* UISheetPresentationControllerDelegate_Protocol_h */
