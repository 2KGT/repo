...
//
#ifndef YTIPlaylistCardRenderer_h
#define YTIPlaylistCardRenderer_h
@import Foundation;
...
@interface YTIPlaylistCardRenderer : GPBMessage <YTVideoCardModel>
...
#endif /* YTIPlaylistCardRenderer_h */
