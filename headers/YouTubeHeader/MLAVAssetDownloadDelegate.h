...
//
#ifndef MLAVAssetDownloadDelegate_h
#define MLAVAssetDownloadDelegate_h
@import Foundation;

#include "AVAssetDownloadDelegate-Protocol.h"
#include "MLAVAssetDownloader.h"

@class NSObject, NSString;

@interface MLAVAssetDownloadDelegate : NSObject <AVAssetDownloadDelegate>

@property (retain, nonatomic) MLAVAssetDownloader *downloader;
...
#endif /* MLAVAssetDownloadDelegate_h */
