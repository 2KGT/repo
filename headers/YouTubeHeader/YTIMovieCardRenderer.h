...
//
#ifndef YTIMovieCardRenderer_h
#define YTIMovieCardRenderer_h
@import Foundation;
...
#include "YTIMovieCardBadgeSupportedRenderers.h"
...
@interface YTIMovieCardRenderer : GPBMessage <YTVideoCardModel>
...
@property (retain, nonatomic) YTIMovieCardBadgeSupportedRenderers *movieBadge;
@property (nonatomic) _Bool hasMovieBadge;
