...
//
#ifndef YTIPlaylistSidebarRenderer_h
#define YTIPlaylistSidebarRenderer_h
@import Foundation;
...
@interface YTIPlaylistSidebarRenderer : GPBMessage
...
#endif /* YTIPlaylistSidebarRenderer_h */
