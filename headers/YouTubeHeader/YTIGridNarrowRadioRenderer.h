...
//
#ifndef YTIGridNarrowRadioRenderer_h
#define YTIGridNarrowRadioRenderer_h
@import Foundation;
...
@interface YTIGridNarrowRadioRenderer : GPBMessage <YTGridVideoViewModel>
...
#endif /* YTIGridNarrowRadioRenderer_h */
