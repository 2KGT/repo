...
//
#ifndef ASTextSelectionView_h
#define ASTextSelectionView_h
@import Foundation;
...
@interface ASTextSelectionView : UIView <UITextInput>

@property (weak, nonatomic) ASTextNode *textNode;
