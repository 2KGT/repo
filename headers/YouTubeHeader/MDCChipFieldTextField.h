...
//
#ifndef MDCChipFieldTextField_h
#define MDCChipFieldTextField_h
@import Foundation;
...
@property (weak, nonatomic) id <MDCChipFieldTextFieldDelegate> deletionDelegate;
