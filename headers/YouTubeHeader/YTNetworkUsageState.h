...
//
#ifndef YTNetworkUsageState_h
#define YTNetworkUsageState_h
@import Foundation;
...
@property (readonly, nonatomic) NSArray *allUsages;
...
/* instance methods */
- (id)initWithNetworkUsages:(id)usages;
- (_Bool)isEqual:(id)equal;
- (unsigned long long)hash;

@end

#endif /* YTNetworkUsageState_h */
