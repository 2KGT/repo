...
//
#ifndef YTICompactRadioRenderer_h
#define YTICompactRadioRenderer_h
@import Foundation;
...
@interface YTICompactRadioRenderer : GPBMessage <YTGridVideoViewModel>
...
#endif /* YTICompactRadioRenderer_h */
