...
//
#ifndef YTIGridNarrowVideoRenderer_h
#define YTIGridNarrowVideoRenderer_h
@import Foundation;
...
@interface YTIGridNarrowVideoRenderer : GPBMessage <YTGridVideoViewModel>
...
@property (nonatomic) int titleMaxLineCount;
@property (nonatomic) _Bool hasTitleMaxLineCount;
...
@property (retain, nonatomic) YTIButtonSupportedRenderers *bottomButtons;
@property (nonatomic) _Bool hasBottomButtons;
...
#endif /* YTIGridNarrowVideoRenderer_h */
