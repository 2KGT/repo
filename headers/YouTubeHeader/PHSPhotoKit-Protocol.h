...
//
#ifndef PHSPhotoKit_Protocol_h
#define PHSPhotoKit_Protocol_h
@import Foundation;

#include "NSObject-Protocol.h"

@class PHAssetResourceManager, PHCachingImageManager, PHImageManager;

@protocol PHSPhotoKit <NSObject>
