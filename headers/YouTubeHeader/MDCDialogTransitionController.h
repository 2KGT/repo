...
//
#ifndef MDCDialogTransitionController_h
#define MDCDialogTransitionController_h
@import Foundation;
...
@property (nonatomic) double opacityAnimationDuration;
@property (nonatomic) double scaleAnimationDuration;
@property (nonatomic) double dialogInitialScaleFactor;
...
@property (nonatomic) _Bool usesGlassEffect;
...
#endif /* MDCDialogTransitionController_h */
